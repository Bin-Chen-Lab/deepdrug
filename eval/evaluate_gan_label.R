...
print(paste("control gene 9 mean", mean(lincs_signatures[9,]), " sd ", sd(lincs_signatures[9,])))
print(paste("control gene 153 mean", mean(lincs_signatures[153,]), " sd ", sd(lincs_signatures[153,])))
print(paste("gene 1 mean", mean(lincs_signatures[1,]), " sd ", sd(lincs_signatures[1,])))
landmark <- 1
